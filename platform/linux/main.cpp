...
int main(int argc, char* argv[]) {
	...
	Config cfg = loadConfig("./assets/config.ini");
    ...
    //carga el Skin
    std::string skinPath = "assets/Skins/" + cfg.SkinName + "/skin.ini";
    loadColors(skinPath);
    ...
    if (!LoadTexture(("assets/Skins/" + cfg.SkinName + "/font.png").c_str(), Textures[0].iID)) {
        std::cerr << "Error cargando font.png" << std::endl;
        return -1;
    }	
    
	Textures.push_back(Texture());
    if (!LoadTexture(("assets/Skins/"+cfg.SkinName+"/origen.png").c_str(), Textures[1].iID)) {
        std::cerr << "Error cargando origen.png" << std::endl;
        return -1;
    }

	Textures.push_back(Texture());
    if (!LoadTexture(("assets/Skins/"+cfg.SkinName+"/cursor3d.png").c_str(), Textures[2].iID)) {
        std::cerr << "Error cargando cursor3d.png" << std::endl;
        return -1;
    }

	Textures.push_back(Texture());
    if (!LoadTexture(("assets/Skins/"+cfg.SkinName+"/relationshipLine.png").c_str(), Textures[3].iID)) {
        std::cerr << "Error cargando relationshipLine.png" << std::endl;
        return -1;
    }

	Textures.push_back(Texture());
    if (!LoadTexture(("assets/Skins/"+cfg.SkinName+"/lamp.png").c_str(), Textures[4].iID)) {
